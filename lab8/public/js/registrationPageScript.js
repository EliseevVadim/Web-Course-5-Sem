...
let elements = passwordArea.children;
let passwordField = elements[0];
let switcher = elements[1];
...
switcher.onclick = function () {
    if (passwordField.getAttribute('type') === 'password') {
        ...
        switcher.innerHTML = '';
        switcher.innerHTML = visiblePasswordIcon;
    }
    else {
        passwordField.setAttribute('type', 'password');
        switcher.innerHTML = '';
        switcher.innerHTML = invisiblePasswordIcon;
    }
}
