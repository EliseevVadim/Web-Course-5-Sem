...
<head>
    ...
    <link rel="stylesheet" href="{{ url('css/authorizationPageStyle.css') }}">
    <title>Авторизация</title>
</head>
<body>
<div id="authorization-area">
    <form action="/authorize/check" method="post">
        @csrf
        <h1>Авторизация</h1>
        <?php
            session_start();
            if(isset($_SESSION['auth_error'])) {
                echo '<h2 style="color: red; font-size: 2em">Ошибка входа</h2>';
        ...
        <div id="password-area">
            <input type="password" placeholder="Введите пароль..." name="password" minlength="6" required>
